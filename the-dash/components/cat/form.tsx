...
const formSchema = z.object({
  ...
  max: z.string().min(1, { message: "This field has to be filled." }),
...
export const CatForm = ({
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    const res = data ? await updateCat(values, data.id) : await createCat(values);
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <DrawerHeader className="gap-1">
              <DrawerTitle>{data ? "Update" : "Create"} Cat</DrawerTitle>
              <DrawerDescription>Manage cat data below.</DrawerDescription>
            </DrawerHeader>
