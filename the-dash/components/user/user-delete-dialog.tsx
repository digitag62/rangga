...
export const DeleteDialogUser = ({ data, setIsOpen, setSelected }: { data: UserWithRoleProps; setIsOpen: (val: boolean) => void; setSelected: (role: UserWithRoleProps | null) => void }) => {
