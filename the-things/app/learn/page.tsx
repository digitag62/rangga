			...
			<main className="flex flex-col row-start-2 gap-[24px]">
				...
				<ol className="list-inside list-decimal text-sm/6 font-[family-name:var(--font-geist-mono)]">
					<li className="text-muted-foreground hover:text-accent-foreground">
						<Link href="/fetch" className="hover:underline hover:underline-offset-4">
							Fetch (SSR/CSR/SSG/ISR)
						</Link>
					</li>
					<li className="text-muted-foreground hover:text-accent-foreground">
						<Link href="/auth" className="hover:underline hover:underline-offset-4">
							Auth (Email/Oauth)
						</Link>
					</li>
					<li className="text-muted-foreground hover:text-accent-foreground">
						<Link href="/deployment" className="hover:underline hover:underline-offset-4">
