			...
			<main className="flex flex-col row-start-2 gap-[24px]">
				...
				<div className="flex flex-col justify-center max-w-[600px] gap-4 text-muted-foreground">
					...
					<p>
						...
						<span className="bg-black/[.05] dark:bg-white/[.06] px-1 py-0.5 rounded text-sm/6 font-[family-name:var(--font-geist-mono)] font-semibold text-accent-foreground">revalidate</span> but will not be shows instantly. Need to reload two times (or get visited by more than 1 users).
					</p>
				</div>
			</main>
		</>
